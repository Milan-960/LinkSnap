    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold text-white">LinkSnap</span>
            </div>
            <p className="text-sm">
              A simple, fast, and secure URL shortener built with React and
              modern web technologies. Create short links in seconds!
            </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-gray-700 pt-6 md:flex-row">
          <p className="text-sm">
            © {currentYear} LinkSnap. All rights reserved.
          </p>
          <p className="mt-2 text-sm md:mt-0">
            Made with ❤️ by{' '}
            <a href="https://www.milansachani.dev/" target="_blank" className="text-indigo-400 hover:text-indigo-300">
              Milan
            </a>
          </p>
        </div>
